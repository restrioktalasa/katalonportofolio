...
public class login {
	@Keyword
	def logintopage (String username, String password) {
	...
	@Keyword
	def logout () {
		WebUI.click(findTestObject('Object Repository/1. Login Page/Button_Open Menu'))
		WebUI.click(findTestObject('Object Repository/1. Login Page/Button_Logout'))
	}
}
